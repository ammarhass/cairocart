odoo.define('dynamic_accounts_report.partner_ledger', function(require) {
	...
	var PartnerLedger = AbstractAction.extend({
		...
		init: function(parent, action) {
		    ...
		    this.report_options = action.params.active_id;
		    this.odoo_context.partner_id = action.params.active_id;
//		    console.log('action.params',action.params)
//		    console.log('this.odoo_context',this.odoo_context)
//		    console.log('this.report_options',this.report_options)
		...
		start: function() {
			var self = this;
			const partner_id = this.odoo_context.partner_id;
//			console.log('partner_id',partner_id)
			self.initial_render = true;
			let args = [{}];  // Default argument for the RPC call

    // Check if the partner_id is valid
            if (partner_id) {
